...
function query(collectionName) {
    ...
    // console.log('from cache',collection)
...
async function insertCurrency(collectionName, currency) {
    utils.storeToStorage(collectionName, currency)
    return Promise.resolve()
}

function currencyQuery(collectionName) {
    var collection = utils.loadFromStorage(collectionName);
